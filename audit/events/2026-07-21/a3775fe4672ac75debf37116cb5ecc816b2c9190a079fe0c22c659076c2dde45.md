# Audit Event a3775fe4672ac75debf37116cb5ecc816b2c9190a079fe0c22c659076c2dde45
...
```diff
diff --git a/tmp/tmp.H0q1T2vfQt/before b/tmp/tmp.H0q1T2vfQt/after
index 1d717542..c24910b7 100644
--- a/tmp/tmp.H0q1T2vfQt/before
+++ b/tmp/tmp.H0q1T2vfQt/after
@@ -1 +1,65 @@
-Milestone spec moved to: [docs/milestones/Java2Kotlin.md](https://github.com/tekkura/sr-android/blob/main/docs/milestones/Java2Kotlin.md)
