...
class FullLoopCommTest {
    ...
    private lateinit var transport: MockSerialTransport
    ...
    fun setUp() {
        ...
        transport = MockSerialTransport(simulator)
        ...
        commManager = SerialCommManager(transport, batteryData, wheelData)
    }
    ...
    fun testSetMotorLevelsRoundTrip() {
        ...
        // For 1.0f -> -5.06V -> 0xF9 (based on previous RP2040OutgoingCommand tests)
        // For -1.0f -> 5.06V -> 0xFA
    ...
    fun testGetLogRoundTrip() {
        ...
        // We can't easily subscribe to logs via BatteryData/WheelData, 
        // so we'll just check if the simulator cleared them after GET_LOG
