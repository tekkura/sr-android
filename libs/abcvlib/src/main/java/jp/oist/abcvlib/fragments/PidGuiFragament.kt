 ...
 * Use the [PidGuiFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PidGuiFragment : Fragment {
    ...
    private var balancePIDController: BalancePIDController? = null
    ...
    constructor(balancePIDController: BalancePIDController) {
        this.balancePIDController = balancePIDController
    }

    companion object {
        private val TAG = PidGuiFragment::class.java.simpleName
        /**
        ...
        fun newInstance(balancePIDController: BalancePIDController): PidGuiFragment {
            return PidGuiFragment(balancePIDController)
        }
    }
