...
class WheelData(
     ...
     * called from the publisher located in [AbcvlibLooper.loop]. <br></br><br></br>
     * 
     ...
     * provides three different calculations for speed. <br></br><br></br>
     * 1.) [SingleWheelData.speedInstantaneous] is the speed between single timesteps
     * (and therefore usually zero in value)<br></br><br></br>
     ...
     * [WheelData.WheelData] constructor or via the
     * [WheelData.Builder.setBufferLength] builder method when creating an instance of
     * WheelData.<br></br><br></br>
     ...
     * can be set via the [WheelData.WheelData] constructor or via the
     * [WheelData.Builder.setExpWeight] builder method when creating an instance of
     * WheelData.<br></br><br></br>
     * 
     * Finally, this method then acts as
     * a publisher to any subscribers/listeners that implement the [WheelDataSubscriber]
     * interface and passes this quadrature encoder pin state to <br></br><br></br>
    ...
    private class SingleWheelData(private val bufferLength: Int, private var expWeight: Double) {
        ...
        var mmPerCount: Double = (2 * Math.PI * 30) / 128

        init {
            idxHeadPrev = idxHead - 1
            encoderCount = IntArray(bufferLength)
            distance = DoubleArray(bufferLength)
            timestamps = LongArray(bufferLength)
        }
         ...
         * corresponds to the A and B IO.<br></br><br></br>
         * 
         * <img src="../../../../../../../../../../media/images/hubeeWheel.gif"></img>
         * <br></br><br></br>
         * 
         * encoderAWheelStatePrevious and encoderBWheelStatePrevious are previous state of their
         * corresponding variables.<br></br><br></br>
         * 
         * IN1  IN2 PWM Standby Result<br></br>
         * H    H   H/L H   Stop-Brake<br></br>
         * L    H   H   H   Turn Forwards<br></br>
         * L    H   L   H   Stop-Brake<br></br>
         * H    L   H   H   Turn Backwards<br></br>
         * H    L   L   H   Stop-Brake<br></br>
         * L    L   H/L H   Stop-NoBrake<br></br>
         * H/L  H/L H/L L   Standby<br></br><br></br>
         * 
         * See: [http://www.creative-robotics.com/quadrature-intro](http://www.creative-robotics.com/quadrature-intro)
         */
        @Synchronized
