# Communication Protocol Contract (v1.1.0)
...
| `TF_CKSUM_TYPE`   | `TF_CKSUM_CRC16` | CRC16-ARC for header and payload   |
...
*   **CRC16 Implementation**: Must use **CRC16-ARC** (Polynomial 0x8005, Reflected). This is the default CRC16 variant in TinyFrame v2.3.0.
